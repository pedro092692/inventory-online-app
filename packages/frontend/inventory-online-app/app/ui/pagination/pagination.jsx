...
export default function Pagination({currentPage, totalPages, maxVisiblePages, setOffset, limit, fetchData, param, searchTerm=null}) {
    ...
    const changePage = (pageNumber) => {
        HandlePageChange(pageNumber, setOffset, limit, fetchData, searchTerm)
