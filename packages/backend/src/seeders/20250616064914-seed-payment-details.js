...
/**
   * Inserts fake payment details data into the `payment_details` table within the specified schema.
   *
...
export default {
  ...
  /**
   * Deletes all data from the `payment_details` table within the specified schema.
